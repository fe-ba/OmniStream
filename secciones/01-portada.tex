...
\newcommand{\IntegrantesA}{Helberth Alejandro Garcia Melo}
\newcommand{\IntegrantesB}{Joshoa Alarcón Sánchez}
\newcommand{\IntegrantesC}{Ferney Eduardo Ballesta Avila}

\newcommand{\CabeceraComun}{
	\CabeceraDePoster{\MATERIA} 
	\begin{NuevoParrafo}{0}{78}[16][6]
		\begin{Marco}[\LineaSupC][\LineaInfC][\LineaIzqC][\LineaDerC][CBlanco]
			\autores{\IntegrantesA}{\IntegrantesB}{\IntegrantesC}
		\end{Marco}
	\end{NuevoParrafo} 
	\CiudadFechaVolumen
}
